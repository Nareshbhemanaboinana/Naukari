...
public class Print_Original_Receipt extends Login{
	
	

	
	@Test
	public void Print_Orgnl_Rcept_With_Clicking_on_Save_and_Do_Not_Print_Button() throws InterruptedException {
	...
	//   Thread.sleep(3000);
				   ...
				   Thread.sleep(3000);
					...
					Thread.sleep(3000);
							...
							String Approve1 = Approve.getText();
			            		...
			            		Thread.sleep(5000);
			    	            if (Approve1.contains(" Successfully ")) {
            ...
            /*	//	Thread.sleep(3000); 
		         ...
		         driver.findElement(By.xpath("//cr-button[text()=' Cancel ']")).click(); 

		     String Numb= driver.findElement(By.xpath("/html/body/div[2]/div[4]/div/mat-dialog-container/app-student-receipt-print/div/div/div[1]/div/div/div[1]/div[2]/div[1]/span[1]/strong[1]")).getText();


		     if(Numb.equals(Name)) {
		    	 System.out.println("Student Name:"+Numb);
		     }
		     else {
		    	 System.out.println("Student Name:"+Name);
		    	 System.out.println("but in receipt Student Name:"+Numb);
