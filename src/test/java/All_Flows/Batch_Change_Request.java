...
public class Batch_Change_Request {
   ...
   driver.navigate().refresh(); 
	...
	Thread.sleep(4000);
	driver.findElement(By.xpath("//input[@formcontrolname='username']")).sendKeys("Amaravati_Office-II");
	Thread.sleep(4000);
...
zz.executeScript("window.scrollBy(0,500)");
    ...
    //  alert.accept(); // To accept the alert
		  ...
		  WebElement svenexxst = driver.findElement(By.xpath("//a[@href='#/fresh/individualf']"));
			...
			Thread.sleep(3000);
			UM.selectOptionByText(driver,"F_Batch01");
			System.out.println("Enrolled Batch is: F_Batch01");
			Thread.sleep(4000);
...
//   Thread.sleep(3000);
			...
			//	JavascriptExecutor zz = (JavascriptExecutor) driver;
					...
					UM.selectOptionByText(driver, "Amaravati_Admin");
					Thread.sleep(2000);
					...
					Thread.sleep(2000);
							   ...
							   WebElement LogoutButton = driver.findElement(By.xpath("//span[text()='LOGOUT ']"));
								//JavascriptExecutor zz = (JavascriptExecutor) driver;
									...
									Thread.sleep(4000);
									driver.findElement(By.xpath("//input[@formcontrolname='username']")).sendKeys("Amaravati_Admin");
									Thread.sleep(4000);
									...
									Thread.sleep(5000);
                /*
				      driver.findElement(By.cssSelector("mat-select[formcontrolname='userCategoryId']")).click();			
				     	Thread.sleep(2000);
						UM.selectOptionByText(driver, "QA_Admin (QQ)");
				     	Thread.sleep(3000);
			...
			if(StudentDetails.contains(Name)) {
				...
				UM.selectOptionByText(driver, "F_Batch02");
				System.out.println("Changing Batch : F_Batch02");
				Thread.sleep(3000);
		...
		//	driver.close();
			...
			if(changedBatch.equals("F_Batch02")) {
