...
public class Inter_City_Transfer_Request extends Login{
	
	@Test
	public void Inter_City_Transfer_Request_Within_Office() throws InterruptedException, FindFailed {
...
//   Thread.sleep(3000);
			...
			//	JavascriptExecutor zz = (JavascriptExecutor) driver;
					...
					driver.findElement(By.xpath("//span[text()='Inter-City Transfer Request']")).click();
					...
					WebElement New_Cuty = driver.findElement(By.cssSelector("mat-select[formcontrolname='newCity']"));

					New_Cuty.click();
					Thread.sleep(2000);

					UM.selectOptionByText(driver,  "Ahmedabad");

					driver.findElement(By.cssSelector("mat-select[formcontrolname='newOffice']")).click();
	          
					Thread.sleep(2000);

					UM.selectOptionByText(driver,  "MNLR_Office-II");
					Thread.sleep(2000);

					driver.findElement(By.cssSelector("input[formcontrolname='sRemarks']")).sendKeys("Inter-City Transfer Request");
					Thread.sleep(2000);

					driver.findElement(By.xpath("//span[text()=' Request for Transfer ']")).click();
					Thread.sleep(2000);
					   ...
					   WebElement LogoutButton = driver.findElement(By.xpath("//span[text()='LOGOUT ']"));
						//JavascriptExecutor zz = (JavascriptExecutor) driver;
							...
							Thread.sleep(4000);
							driver.findElement(By.xpath("//input[@formcontrolname='username']")).sendKeys("MNLR-Councellor-II");
							Thread.sleep(4000);

							driver.findElement(By.xpath("//input[@formcontrolname='password']")).sendKeys("MNLR@123");
				  ...
				  WebElement Updatetrnsfer = driver.findElement(By.xpath("//a[@href='#/fresh/view']"));
								//JavascriptExecutor zz = (JavascriptExecutor) driver;
				 zz.executeScript("arguments[0].scrollIntoView()", Updatetrnsfer);
					Thread.sleep(5000);
				zz.executeScript("arguments[0].click()", Updatetrnsfer);
					Thread.sleep(4000);
				...
				driver.findElement(By.xpath("//span[text()=' Update ']")).click();
				Thread.sleep(2000);
				  WebElement Pending = driver.findElement(By.xpath("//a[@href='#/fresh/pending']"));
;
					//JavascriptExecutor zz = (JavascriptExecutor) driver;
	              zz.executeScript("arguments[0].scrollIntoView()", Pending);
					Thread.sleep(4000);

				driver.findElement(By.xpath("//a[@href='#/fresh/pending']")).click();
				Thread.sleep(2000);
