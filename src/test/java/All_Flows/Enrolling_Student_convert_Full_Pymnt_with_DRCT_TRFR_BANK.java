...
public class Enrolling_Student_convert_Full_Pymnt_with_DRCT_TRFR_BANK extends Login{
	
	@Test
	public void Enrolling_Student_convert_Full_Peyment_with_Cash_DRCT_TRFR_BANK() throws InterruptedException, FindFailed, HeadlessException, UnsupportedFlavorException, IOException {
	...
	zz.executeScript("window.scrollBy(0,500)");
	    ...
	    //  alert.accept(); // To accept the alert
			  ...
			  WebElement svenexxst = driver.findElement(By.xpath("//a[@href='#/fresh/individualf']"));
				...
				Thread.sleep(3000);
				UM.selectOptionByText(driver, "MBA-HR_B002");
				System.out.println("Enrolled Batch is: MBA-HR_B002");
				Thread.sleep(4000);
		        actions.sendKeys(Keys.TAB).perform();
							Thread.sleep(3000);
