...
public class Enroll_Student_Combo_Course_with_cash_Payment extends Login {
	
	

	@Test
	public void Enroll_Student_complete_flow_with_Combo_Course_with_cash_Payment() throws InterruptedException, FindFailed, HeadlessException, UnsupportedFlavorException, IOException {
	    ...
	    //  alert.accept(); // To accept the alert
			...
			//	JavascriptExecutor zz = (JavascriptExecutor) driver;
				...
				Thread.sleep(2000);
			      ...
			      driver.findElement(By.cssSelector("mat-select[formcontrolname='coursestype']")).click();			
				Thread.sleep(2000);

				UM.selectOptionByText(driver, "Combo");

				Thread.sleep(3000);
			      driver.findElement(By.cssSelector("mat-select[formcontrolname='combo_subcourse']")).click();			
					Thread.sleep(3000);

					UM.selectOptionByText(driver, "Test CAT-2025 SLT + Test GMAT-2025");
					Thread.sleep(3000);

					driver.findElement(By.xpath("/html/body/app-root/app-main-layout/app-individualf/section/div/div[2]/div/div/div/mat-tab-group/div/mat-tab-body/div/div/div/mat-vertical-stepper/div[2]/div/div/div/form[1]/div/div[3]/div/div[1]/div[2]/mat-form-field/div/div[1]/div[3]/mat-select/div/div[2]/div")).click();
					Thread.sleep(7000);

					
					UM.selectOptionByText(driver, "GMAT25SLTC");
					Thread.sleep(3000);
					driver.findElement(By.xpath("/html/body/app-root/app-main-layout/app-individualf/section/div/div[2]/div/div/div/mat-tab-group/div/mat-tab-body/div/div/div/mat-vertical-stepper/div[2]/div/div/div/form[1]/div/div[3]/div/div[2]/div[2]/mat-form-field/div/div[1]/div[3]/mat-select/div/div[2]")).click();
					Thread.sleep(7000);

					UM.selectOptionByText(driver, "CAT25SLTC");

				System.out.println("Enrolled Batch is: Test CAT-2025 SLT + Test GMAT-2025");
				Thread.sleep(4000);
		        ...
		        int fstinstallmenter= copiedInteger1-5000;
		        String fstinstallment = String.valueOf(fstinstallmenter);
		        System.out.println("Discount Amount :"+fstinstallment);
				   Thread.sleep(3000);
	...
	int Amont=copiedInteger1;
	int stinstall=Amont/2;
	...
	for (int i = 0; i < inputs.length; i++) {
	    ...
	    inputs[0].sendKeys("1");
	    inputs[1].sendKeys(String.valueOf(stinstall));
	    inputs[2].sendKeys(today.format(formatter));

	    inputs[3].sendKeys("2");
	    inputs[4].sendKeys(String.valueOf(stinstall));
	    ...
	    Thread.sleep(3000);
			...
			//	   String fstinstallment =driver.findElement(By.xpath("/html/body/app-root/app-main-layout/app-individualf/section/div/div[2]/div/div/div/mat-tab-group/div/mat-tab-body[1]/div/div/div/mat-vertical-stepper/div[2]/div/div/div/form/div[1]/div[7]/div/div[1]/div/div/table/tbody/tr[1]/td[2]")).getText();
				...
				List<WebElement> ddropdowns = driver.findElements(By.cssSelector("mat-select"));
					WebElement eeightDropdown = ddropdowns.get(8);

			        // Click on the dropdown to open it
				//	nineDropdown.click();	
					eeightDropdown.click();
					//  driver.findElement(By.cssSelector("mat-select[formcontrolname='paymentMode']")).click();			
