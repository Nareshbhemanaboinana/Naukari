...
/*
  ...
  */
	  ...
	  public  static void scrollviewandclick(WebDriver driver, String visibletext) throws InterruptedException {
			 driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
			//  WebDriverWait wait = new WebDriverWait(driver, 10);
		      //  wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[@href='#/admin/"+visibletext+"']")));


			  WebElement svenextt = driver.findElement(By.xpath("//a[@href='#"+visibletext+"']"));
