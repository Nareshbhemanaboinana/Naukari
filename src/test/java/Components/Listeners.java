...
public class Listeners extends ExtendreportsNG implements ITestListener{
	ExtentTest test;
	...
	public void onTestFailure( ITestResult results ) {
		  String consoleOutputString = consoleOutput.toString();
		    ...
		    test.log(Status.FAIL, MarkupHelper.createLabel("<span style='color: black;'>Test is Fail</span><br><pre style='border: 1px solid red; padding: 10px; color: black; background-color: red; font-weight: bold;'>" + consoleOutputString + "</pre>", ExtentColor.RED));
		...
		try {
			test.addScreenCaptureFromPath(System.getProperty("user.dir")+"//Repots//index.html"+df1.format(dt)+".png");
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}//
