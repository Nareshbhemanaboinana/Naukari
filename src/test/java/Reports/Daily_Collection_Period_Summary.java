...
public class Daily_Collection_Period_Summary extends Login1 {
	
	
	@Test
	public void Daily_Collection_Period_Summary_Reports() throws InterruptedException {
...
Thread.sleep(3000);
 ...
 for (WebElement reportElement : reportElements) {
   ...
   if(reportTitle.contains("Daily Collection Period Summary")) {
...
WebElement courseElement = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/app-root/app-main-layout/app-dailycollectionperiod-summary-report/section/div/div[2]/div/div/div/div[2]/div/div[2]/div[2]/table/thead/tr/th[2]/div/div[1]")));
String course = courseElement.getText();

   if(course.equalsIgnoreCase("Amaravati_Office-II")) {
