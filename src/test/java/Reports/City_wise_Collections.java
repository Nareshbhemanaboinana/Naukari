...
public class City_wise_Collections extends Login1 {
	
	@Test
	public void City_wise_Collections_Reports() throws InterruptedException {
...
Thread.sleep(6000);
 ...
 for (WebElement reportElement : reportElements) {
   ...
   if(reportTitle.contains("City wise Collections")) {
...
WebElement courseElement = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/app-root/app-main-layout/app-citywisecollection-report/section/div/div[2]/div/div/div/div[2]/div/div[2]/div[2]/table/tbody/tr/td[1]")));
