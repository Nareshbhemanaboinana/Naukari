...
public class SubCourse_Wise_Revenue_Report extends Login1 {
	
	
	@Test
	public void SubCourse_Wise_Revenue_Reports() throws InterruptedException {
			...
			zz.executeScript("arguments[0].click()", Reports);
			   ...
			   Thread.sleep(6000);
				...
				driver.findElement(By.xpath("//div[text()='Collections']")).click();
				   Thread.sleep(3000);
				   WebElement Revenue = 	driver.findElement(By.xpath("(//h1[@class='text-center py-4'])[11]"));
					//JavascriptExecutor zz = (JavascriptExecutor) driver;
					zz.executeScript("arguments[0].scrollIntoView()", Revenue);
					Thread.sleep(5000);
					driver.findElement(By.xpath("(//button[@color='primary'])[11]")).click();
					   Thread.sleep(3000);
					...
					driver.findElement(By.cssSelector("mat-select[formcontrolname='course']")).click();
					   Thread.sleep(3000);

					UM.selectOptionByText(driver,  "MBA");
					   Thread.sleep(3000);

	              driver.findElement(By.cssSelector("mat-select[formcontrolname='subCourse']")).click();
				   Thread.sleep(3000);
