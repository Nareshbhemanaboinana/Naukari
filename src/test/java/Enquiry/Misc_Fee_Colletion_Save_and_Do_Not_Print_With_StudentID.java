...
public class Misc_Fee_Colletion_Save_and_Do_Not_Print_With_StudentID extends Misc_feeCollection {

	//@Test(dependsOnMethods={"Enquiry.Enrolling_Student.Enrolling"})
		@Test
		public void Misc_Fee_Colletions_Save_and_Do_Not () throws InterruptedException {
			...
			Misc_feeCollection.ClickSaveandDoNotPrint(driver);
